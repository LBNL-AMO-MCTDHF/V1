...
C  DJH: these are functions used by dgmres that come from opkda1.f.
C   I removed dlsodpk as it was the largest file in the distribution and
C   I have odex.f which should be ok if needed.
C   Presumably I removed these from the dgmres files.  Keeping these
C    not reinstating those to ensure continuity and peace of mind.
