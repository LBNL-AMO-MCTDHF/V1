...
C
C***SEE ALSO  DGMRES
C***ROUTINES CALLED  DAXPY, DDOT, djhDNRM2
...
C     .. External Functions ..
      DOUBLE PRECISION DDOT, djhDNRM2
      EXTERNAL DDOT, djhDNRM2
...
!!      print *, "STOPNOW"; call mpistop()
      
      print *, "VNRM"
      VNRM = djhDNRM2(N, VNEW, 1)


      print *, "goblahghyy ", vnrm,ll,myrank
...
C   -------------------------------------------------------------------
 ...
 30   CONTINUE
      ...
      print *, "ORTHRETURN ", snormw,sumdsq,myrank
