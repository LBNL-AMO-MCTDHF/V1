...
c djh for parallel - calls dpigmr

c!! myrank temporary

*DECK DGMRES
      SUBROUTINE DGMRESPAR (N, B, X, NELT, IA, JA, A, ISYM, 
     +   MATVEC, MSOLVE,
     +   ITOL, TOL, ITMAX, ITER, ERR, IERR, IUNIT, SB, SX, RGWK, LRGW,
     +   IGWK, LIGW, RWORK, IWORK, myrank)
...
C***ROUTINES CALLED  D1MACH, DCOPY, djhDNRM2, DPIGMR
...
ccc      write(971,*)
ccc      write(971,*) "In dgmrespar."
c      temp1=djhDNRM2(N,B,1)
c      temp2=djhDNRM2(N,X,1)
ccc      write(971,*) "Norms ", temp1,temp2
c      call mpistop()
...
ccc      call openfile()
ccc      write(971,*) "CHECK 1 djhDNRM2: ", BNRM
ccc      call closefile()
...
!!      print *, "GOPIGMR", myrank
     ...
     $       TOL, NELT, IA, JA, A, ISYM, IUNIT, IFLAG, ERR)
      ...
      print *, "called PIGMR ", myrank,iter,iflag
